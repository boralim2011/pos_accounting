...
insert  into `item`(`item_id`,`item_code`,`item_name`,`item_name_kh`,`barcode`,`model`,`image`,`unit_id`,`item_type_id`,`item_group_id`,`item_class_id`,`maker_id`,`kg`,`size`,`Min`,`Max`,`income_account_id`,`inventory_account_id`,`cogs_account_id`,`expense_account_id`,`default_lot_id`,`purchasing_price`,`selling_price`,`cogs_method`,`is_active`,`is_editable`,`is_deletable`) values (3,'Item A','Item A','Item A','Item A','','Item_A.jpg',1,1,2,1,1,0,NULL,0,0,NULL,NULL,NULL,NULL,1,0,5,1,1,1,1),(67,'000001','Item B','Item B','Item B','','000001.jpg',1,1,1,1,1,0,NULL,0,0,NULL,NULL,NULL,NULL,1,0,30,1,1,1,1),(83,'SR-0001','ssss','ssss','SR-0001',NULL,'SR-0001.png',1,3,1,1,NULL,0,NULL,0,0,NULL,NULL,NULL,NULL,NULL,0,60,1,1,1,1);
...
insert  into `journal`(`journal_id`,`journal_date`,`journal_no`,`document_no`,`contact_id`,`branch_id`,`room_id`,`age_range_id`,`gender`,`card_id`,`currency_id`,`exchange_rate`,`transaction_type_id`,`journal_status`,`warehouse_id`,`total`,`total_company_currency`,`discount`,`note`,`created_by`,`created_date`,`modified_by`,`modified_date`) values (27,'2017-05-28 00:00:00','INV-17050001',NULL,NULL,NULL,1,1,'O',5,1,4000,NULL,1,NULL,35,35,10,NULL,1,'2017-05-28 11:48:57',1,'2017-06-11 15:05:58'),(28,'2017-06-03 00:00:00','INV-17060001',NULL,NULL,NULL,1,1,'O',NULL,1,4000,NULL,1,NULL,95,95,0,NULL,1,'2017-06-03 08:30:55',1,'2017-06-03 08:30:55'),(29,'2017-06-11 00:00:00','boralim2011@gmail.com',NULL,NULL,NULL,1,1,'O',5,1,4000,NULL,1,NULL,95,95,10,NULL,1,'2017-06-11 08:41:47',1,'2017-06-11 14:31:59'),(30,'2017-06-11 00:00:00','INV-17060002',NULL,NULL,NULL,3,1,'O',5,1,4000,NULL,1,NULL,95,95,10,NULL,1,'2017-06-11 13:07:14',1,'2017-06-11 13:07:14');
...
insert  into `journal_item`(`journal_item_id`,`journal_id`,`item_id`,`cost`,`price`,`qty`,`discount`,`description`,`lot_id`) values (77,27,3,0,5,1,1,'',0),(78,27,67,0,30,1,1,'',0),(79,28,67,0,30,1,1,'',0),(80,28,83,0,60,1,1,'',0),(81,28,3,0,5,1,1,NULL,NULL),(82,29,3,0,5,1,1,'',0),(83,29,67,0,30,1,1,'',0),(84,29,83,0,60,1,1,'',0),(85,30,3,0,5,1,1,'',0),(86,30,83,0,60,1,1,'',0),(87,30,67,0,30,1,1,'',0);
...
CREATE TABLE `payment` (
  ...
  `card_id` int(11) DEFAULT NULL,
  `exchange_rate` float DEFAULT NULL,
  `amount` float DEFAULT NULL COMMENT 'receive_amount-refund',
  `receive_amount_riel` float DEFAULT NULL,
  `receive_amount` float DEFAULT NULL,
  `refund_riel` float DEFAULT NULL,
...
insert  into `payment_method`(`payment_method_id`,`payment_method_name`) values (1,'Cash'),(2,'Card'),(3,'Wing'),(4,'Fast Pay');
