...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var t = $('#agency-table').DataTable( {
            ...
            //    var btn_delete = '<a href="#" onclick="delete_agency('+ contact_id +')" class="inline-button" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash-o text-red"></i> </a>';
            //    var btn_edit = '<a href="#" onclick="edit_agency('+contact_id+')" class="inline-button" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil text-orange"></i> </a>';
    ...
    $(document).ready(function(){
        ...
        $(document).on("click",".btn-delete", function(event){
            ...
            $(document).on("click", "#dialog-confirm #btn-ok", function(event){
                ...
                $.ajax({
                    //url: '<?php //echo base_url();?>agency_group/delete',
                    url: btn.attr("url"),
                    type: 'POST',
                    data: formData,
                    dataType:"json",
