                ...
                <div class="box-header">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <select id="transaction_type_id" name="transaction_type_id" class="form-control select2" data-placeholder="Transaction type"  style="width: 100%;">
                                <option value="0" <?php echo isset($transaction_type_id) && $transaction_type_id==0 ? 'selected="selected"':'';?> >All Item Type</option>
                                <?php if(isset($transaction_types) && is_array($transaction_types))
                                    foreach($transaction_types as $ut){
                                        ?>
                                        <option value="<?php echo $ut->transaction_type_id;?>" <?php echo isset($transaction_type_id) && $transaction_type_id==$ut->transaction_type_id? 'selected="selected"':'';?> ><?php echo $ut->transaction_type_name;?></option>
                                    <?php
                                    }
                                ?>
                            </select>
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <select id="warehouse_id" name="warehouse_id" class="form-control select2" data-placeholder="Warehouse"  style="width: 100%;">
                                <option value="0" <?php echo isset($warehouse_id) && $warehouse_id==0 ? 'selected="selected"':'';?> >All Item Group</option>
                                <?php if(isset($warehouses) && is_array($warehouses))
                                    foreach($warehouses as $ut){
                                        ?>
                                        <option value="<?php echo $ut->warehouse_id;?>" <?php echo isset($warehouse_id) && $warehouse_id==$ut->warehouse_id? 'selected="selected"':'';?> ><?php echo $ut->warehouse_name;?></option>
                                    <?php
                                    }
                                ?>
                            </select>
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <select id="created_by" name="created_by" class="form-control select2" data-placeholder="User"  style="width: 100%;">
                                <option value="0" <?php echo isset($created_by) && $created_by==0 ? 'selected="selected"':'';?> >All User</option>
                                <?php if(isset($users) && is_array($users))
                                    foreach($users as $ut){
                                        ?>
                                        <option value="<?php echo $ut->user_id;?>" <?php echo isset($created_by) && $created_by==$ut->user_id? 'selected="selected"':'';?> ><?php echo $ut->user_name;?></option>
                                    <?php
                                    }
                                ?>
                            </select>
                        ...
                        <?php if(isset($items) && is_array($items)){
                            foreach($items as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#item/edit/<?php echo $row->item_id;?>" data-json='{"journal_id":<?php echo $row->journal_id;?>}' class="inline-button" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil text-orange"></i> </a>
                                        <a href="#" data-json='{"journal_id":<?php echo $row->journal_id;?>}' class="inline-button btn-delete" data-toggle="tooltip" title="Delete" url="<?php echo base_url();?>item/delete"> <i class="fa fa-trash-o text-red"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            }
