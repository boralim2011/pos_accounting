            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <input type="password" class="form-control" id="card_number" name="card_number" placeholder="Enter card number" value="<?php echo isset($card_history->card_number)?$card_history->card_number:""; ?>">
                    </div>
