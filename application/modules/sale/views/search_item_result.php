...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $(document).off("change", "#item_group_id");
        $(document).on("change", "#item_group_id",function(event){
        ...
        function post_search( page=1)
        {
            ...
            var url = "<?php echo base_url()?>sale/search";

            var posting = $.post(
                url,
                { ajax: 1, item_group_id:item_group_id, search_by:search_by, search: search, page: page, display: (count ? count : 10) },
