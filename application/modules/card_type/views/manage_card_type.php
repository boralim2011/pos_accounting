...
<section class="content-header">
    ...
    <li class="active">Manage Card_type</li>
    </ol>
</section>
<!-- Main content -->
        ...
        <div class="col-xs-12">
            <div class="box box-info">
                ...
                <!-- <div class="box-header">
                   <h3 class="box-title">List of Card_type</h3>
                </div>-->
                <div class="box-body">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-xs-12" style="margin-top: 3px;" >
                            <a href="#" class="btn btn-primary" id="btn-new-card_type"><i class="fa fa-plus"></i> Add</a>
                            <a href="#card_type" class="btn btn-primary btn-refresh"><i class="fa fa-refresh"></i> Refresh</a>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-xs-12" style="margin-top: 3px;">
                            <div class="row">
                                <div class="form-group ccol-lg-6 col-sm-6 col-xs-12">
                                    <select id="search_by" name="search_by" class="form-control select2" data-placeholder="Search By"  style="width: 100%;">
                                        <option value="card_type_name" <?php echo isset($search_by) && $search_by=="card_type_name" ? 'selected="selected"':'';?> >Card_type Name</option>
                                        <option value="card_type_name_kh" <?php echo isset($search_by) && $search_by=="card_type_name_kh" ? 'selected="selected"':'';?> >Card_type Name KH</option>
                                    </select>
                                </div>
                ...
                <div class="box-body">
                    <table id="card_type-table" class="table table-bordered table-hover data-table">
                        <thead>
                        <tr>
                            <th>No</th>
                        ...
                        <?php if(isset($card_types) && is_array($card_types)){
                            foreach($card_types as $row){
                                ...
                                <tr>
                                    <td></td>
                                    <td><?php echo isset($row->card_type_name)? $row->card_type_name:"";?></td>
                                    <td><?php echo isset($row->card_type_name_kh)? $row->card_type_name_kh:"";?></td>
                                    <td>
                                        ...
                                        <a href="#" data-json='<?php echo json_encode($row);?>' class="inline-button btn-delete" data-toggle="tooltip" title="Delete" url="<?php echo base_url();?>card_type/delete"> <i class="fa fa-trash-o text-red"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            }
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var t = $('#card_type-table').DataTable( {
            "scrollX": true,
...
//            }
        ...
        function post_search( page=1)
        {
            ...
            var url = "<?php echo base_url()?>card_type/manage_card_type";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on("click",".btn-view", function(event){
            ...
            $("#dialog-card_type .modal-title").html("View Card_type");
            $("#card_type-form").attr('action', '<?php echo base_url()?>card_type/view_detail' );

            var model = JSON.parse($(this).attr('data-json'));
            $("#card_type_id").val(model.card_type_id);
            $("#card_type_name").val(model.card_type_name);
            $("#card_type_name_kh").val(model.card_type_name_kh);

            $("#btn-add-card_type").remove();
        ...
        $(document).on("click",".btn-edit", function(event){
            ...
            $("#dialog-card_type .modal-title").html("Edit Card_type");
            $("#card_type-form").attr('action', '<?php echo base_url()?>card_type/edit' );
        ...
        $(document).on("click",".btn-delete", function(event){
            ...
            $(document).on("click", "#dialog-confirm #btn-ok", function(event){
                ...
                formData.append('card_type_id', model.card_type_id);


                $.ajax({
                    //url: '<?php //echo base_url();?>card_type/delete',
                    url: btn.attr("url"),
                    type: 'POST',
                    data: formData,
                    dataType:"json",
