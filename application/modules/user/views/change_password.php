...
<head>
    ...
    <title>BISSIT | Change Password</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo base_url();?>"><b>BISSIT</b></a>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Change Password</p>
        <form action="<?php echo base_url();?>user/change_password" method="post" name="form-change-password" id="form-change-password">
            ...
            <div class="form-group has-feedback">
                <input name="confirm_password" type="password" class="form-control" placeholder="Confirm Password" value="<?php if(isset($confirm_password)) echo $confirm_password;?>">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="row">
                <div class="col-xs-6">
                    <a href="<?php echo base_url();?>" name="cancel" class="btn btn-default btn-block" >Back</a>
                </div><!-- /.col -->
                <div class="col-xs-6">
...
<script type="text/javascript">
    ...
    {
        $(document).off("submit","#form-change-password");
